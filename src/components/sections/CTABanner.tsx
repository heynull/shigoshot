  ...
  return (
    <section className="bg-[#111111] text-center px-6 md:px-20 py-16 md:py-24">
      <div className="mx-auto max-w-3xl">
        ...
        >
          {/* Headline */}
          <h2 className="text-white text-[clamp(28px,7vw,40px)] md:text-5xl font-bold font-[Montserrat] mb-6 md:mb-8 leading-tight">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="
              w-full md:w-auto px-9 py-4 rounded-full
